...
## Corpus Check
- 48 files · ~6,815 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 313 nodes · 440 edges · 43 communities (38 shown, 5 thin omitted)
- Extraction: 85% EXTRACTED · 15% INFERRED · 0% AMBIGUOUS · INFERRED: 65 edges (avg confidence: 0.72)
...
Cohesion: 0.08
Nodes (15): graph, App, is_command(), parse_command(), main(), LataiApp, 'ascii', 'blank', 'block', 'dashed', 'double', 'heavy', 'hidden', 'hkey', 'inner, stream_response() (+7 more)
...
Cohesion: 0.15
Nodes (3): ScrollableContainer, ChatView, ChatMessage
