...
## Corpus Check
- 45 files · ~6,296 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 278 nodes · 380 edges · 42 communities (36 shown, 6 thin omitted)
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 48 edges (avg confidence: 0.71)
...
5. `Session` - 14 edges
6. `InputBar` - 12 edges
7. `Project: LangGraph Chat TUI` - 12 edges
8. `LataiApp` - 12 edges
...
Cohesion: 0.07
Nodes (16): App, Container, Horizontal, ScrollableContainer, Static, CustomHeader, LataiApp, 'ascii', 'blank', 'block', 'dashed', 'double', 'heavy', 'hidden', 'hkey', 'inner (+8 more)

### Community 1 - "Main TUI App & Orchestration"
Cohesion: 0.13
Nodes (7): graph, is_command(), parse_command(), main(), LataiApp, The main Latai TUI chat application class., stream_response()
...
- **Why does `LataiApp` connect `Main TUI App & Orchestration` to `UI Components & Rendering`, `Command Menus & Navigation`, `Agentic Graph Definition`, `UI Assets & Animation`, `Application Entry Point`, `Community 31`?**
...
- **What connects `BeforeTool`, `Returns a filtered structure of all currently available model options.`, `Instantiate the matching LangChain chat model and invoke it with messages.` to the rest of the system?**
