...
## Corpus Check
- 51 files · ~7,577 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 333 nodes · 463 edges · 46 communities (39 shown, 7 thin omitted)
...
Cohesion: 0.08
Nodes (14): Container, Horizontal, Static, CustomHeader, CustomFooter, CustomHeader, CustomFooter, The application's custom footer bar showing workspace info, selected model, and (+6 more)
...
## Knowledge Gaps
- **35 isolated node(s):** `BeforeTool`, `Identity`, `Code Style`, `Instructions`, `Architecture Rules` (+30 more)
...
- **Why does `LataiApp` connect `Main TUI App & Orchestration` to `UI Components & Rendering`, `Command Menus & Navigation`, `Markdown Parsing & Fences`, `Agentic Graph Definition`, `UI Assets & Animation`, `Community 42`, `Application Entry Point`?**
